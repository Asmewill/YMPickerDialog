...
public class MyDatePickerDialog extends Dialog implements NumberPicker.OnValueChangeListener, View.OnClickListener {
    ...
    //    setNumberPickerDividerColor(mnp_year, Color.TRANSPARENT);
        ...
        mnp_month.setWrapSelectorWheel(true);

    }

    public void setYearValue(int yearValue) {
        mnp_year.setValue(yearValue);
        tv_title_year.setText(yearValue+"");
    }

    public void setMonthValue(int monthValue) {
        mnp_month.setValue(monthValue);
        tv_title_month.setText(monthValue+"");
    }
